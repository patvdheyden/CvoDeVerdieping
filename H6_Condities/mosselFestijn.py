...
if totaal_te_betalen > 100 and aantal_mossel_met_frietjes >= 2:
    korting = totaal_te_betalen * 0.05
...
str_korting = str_format.format("Korting:","", int(korting), "€" )
str_totaal_plus_korting = str_format.format("Af te rekenen" , "", totaal_te_betalen - int(korting),"€")
str_lijn = str_format.format(".", "", "=========","")

print(GF.box(5, 6, str_mosselen, str_kon_hapje, str_drank, str_ijs, str_lijn, str_te_betalen, str_korting, str_totaal_plus_korting))
print("")
ontvangen_bedrag = input("Geef het ontvangen bedrag in: ")
ontvangen_bedrag = int(ontvangen_bedrag)

totaal_te_betalen =  totaal_te_betalen - int(korting)
